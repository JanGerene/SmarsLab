...
class test_leg(unittest.TestCase):
    ...
    def test_create_leg(self):
        ...
        self.assertEqual(leg.min_angle, 0)
        self.assertEqual(leg.max_angle, 90)
        self.assertFalse(leg.invert)
        self.assertEqual(leg._body_angle, 0)
        self.assertEqual(leg._stretch_angle, 90)
        self.assertEqual(leg._swing_angle, 0)
        leg = sl.Leg("test_leg", 0, 50, 150, True)
        self.assertTrue(leg.name == "test_leg")
        self.assertEqual(leg.channel, 0)
        self.assertEqual(leg.min_angle, 50)
        self.assertEqual(leg.max_angle, 150)
        self.assertTrue(leg.invert)
        self.assertEqual(leg._body_angle, 150)
        self.assertEqual(leg._stretch_angle, 50)
        self.assertEqual(leg._swing_angle, 50)
